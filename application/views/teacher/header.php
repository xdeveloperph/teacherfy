                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav ">
                            ...
                            <li class="<?php echo $hdashboard?>"><a href="<?php echo base_url().'teacher/dashboard'?>" >Dashboard</a></li>
                            <li class="<?php echo $hcalendar?>"><a href="<?php echo base_url().'teacher/calendar'?>" >Calendar</a></li>
                            <li class="<?php echo $hroster?>"><a href="<?php echo base_url().'teacher/roster'?>" >Roster</a></li>
                            <li class="<?php echo $hprofile?>"><a href="<?php echo base_url().'teacher/profile'?>" >Profile</a></li>
                            <li class="<?php echo $havailability?>"><a href="<?php echo base_url().'teacher/availability'?>" >Availability</a></li>
